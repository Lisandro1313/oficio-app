...
export default function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 z-40 border-t border-line bg-card/95 backdrop-blur">
      <div className="mx-auto flex max-w-[440px] items-stretch justify-around px-2 py-2">
...
function HeartIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" {...base(active)} fill={active ? "#ea580c" : "none"}>
